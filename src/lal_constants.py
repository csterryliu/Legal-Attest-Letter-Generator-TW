...
NAME_CORDINATE = {
's_x_begin': 4.60 * PDF_INCH,
's_y_begin': 10.27 * PDF_INCH,
's_x_interval': 0.48 * PDF_INCH,
's_y_interval': 0.15 * PDF_INCH,
'r_x_begin': 4.60 * PDF_INCH,
'r_y_begin': 9.65 * PDF_INCH,
'r_x_interval': 0.48 * PDF_INCH,
'r_y_interval': 0.15 * PDF_INCH,
'c_x_begin': 4.60 * PDF_INCH,
'c_y_begin': 9.02 * PDF_INCH,
'c_x_interval': 0.48 * PDF_INCH,
'c_y_interval': 0
}
ADDR_CORDINATE = {
's_x_begin': 4.72 * PDF_INCH,
's_y_begin': 9.95 * PDF_INCH,
's_y_interval': 0.15 * PDF_INCH,
'r_x_begin': 4.72 * PDF_INCH,
'r_y_begin': 9.32 * PDF_INCH,
'r_y_interval': 0.15 * PDF_INCH,
'c_x_begin': 4.72 * PDF_INCH,
'c_y_begin': 8.83 * PDF_INCH,
'c_y_interval': 0
}
